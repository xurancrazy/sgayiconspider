...
BOT_NAME = 'giligiliicon'

SPIDER_MODULES = ['giligiliicon.spiders']
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'giligiliicon.middlewares.CustomUserAgentMiddleware': 543,
}
...
IMAGES_STORE = '/root/xuran_0103/images/icon'
CUSTOMIMAGEPIPELINE_IMAGES_URLS_FIELD = 'img'
CUSTOMIMAGEPIPELINE_IMAGES_RESULT_FIELD = 'img_result'
# Configure item pipelines
# See http://scrapy.readthedocs.org/en/latest/topics/item-pipeline.html
ITEM_PIPELINES = {
    'giligiliicon.pipelines.CustomIconImagePipeline': 100,
    'giligiliicon.pipelines.MySQLStoreIconGiliGiliPipeline': 200
}
